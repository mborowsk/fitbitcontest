...
function sqlCreateCheckTimeTable(){
	...
	$sql_create = 'CREATE TABLE ACCESSCHECK(id CHAR(6) default "my_key", check_sum CHAR(32), ok2access INT default 1, update_datetime DATETIME, update_interval INT default 20, throttle INT default 0, num_previous_days INT default 0)';
	$retval = mysql_query($sql_create, $conn );
	if(! $retval )
	{
  	echo('Could not create database table: ' . mysql_error() . '<br/>');
