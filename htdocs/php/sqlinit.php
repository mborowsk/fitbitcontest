...
function sqlCreateCheckTimeTable(){
	...
	$sql_create = 'CREATE TABLE ACCESSCHECK(id CHAR(6) default "my_key", check_sum CHAR(32), ok2access INT default 1, update_datetime DATETIME, update_interval INT default 2, throttle INT default 0)';
